...
$apiKey = 'hjVyUePOOANgoTiQnVqdkntYwG1fMuFfl';          // Ключ доступа к API
$offer_id = 18448;         // для каждого оффера свой айди, надо уточнять его в админке или у суппортов
$stream_hid = 'M8ztoM02';     // id потока

$landKey = 'b0804c70e3ba4c4b72ab30c172b71a50';
...
$dataOffers = '{"50074":{"id":50074,"name":"Herbo - tonic","country":{"code":"CG","name":"\u041a\u043e\u043d\u0433\u043e"},"price":"27000","price2":"54000","currency":{"code":"XAF","name":"XAF"}}}';
$dataOffer = '{"id":50074,"name":"Herbo - tonic","country":{"code":"CG","name":"\u041a\u043e\u043d\u0433\u043e"},"price":"27000","price2":"54000","currency":{"code":"XAF","name":"XAF"}}';
$is_geo_detect = '';
$productName = 'Herbo - tonic';
$invoice = 'index.php';
$language = 'fr';
$push_link = '';
$fb_verification = '';
...
$companyInfo = array('address' => '109380, Г.МОСКВА, ВН.ТЕР.Г. МУНИЦИПАЛЬНЫЙ ОКРУГ ЛЮБЛИНО, УЛ ЧАГИНСКАЯ, Д. 4, СТР. 13, ПОМЕЩ. 10/2', 'detail' => 'ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ "ОПТ ПРОДАЖА"  ОГРН: 1227700719146  ИНН: 9723174968  КПП: 772301001 e-mail: opt@mail.ru skype : opt');
